...
class CDAMedicationsSectionRequestConverterTest {

    @Test
    public void testDate() throws Exception {
        Resource resource = this.getMedicationRequest("Tests/MedicationINT/MedicationDate.xml");
    ...
    public void testEIVL_TS() throws Exception {
        Resource resource = this.getMedicationRequest("Tests/MedicationINT/MedicationEIVL.xml");
        assertNotNull(resource);
        MedicationRequest medicationRequest = (MedicationRequest) resource;
    ...
    public void testPIVL_TS() throws Exception {
        Resource resource = this.getMedicationRequest("Tests/MedicationINT/MedicationPIVL.xml");
        assertNotNull(resource);
        MedicationRequest medicationRequest = (MedicationRequest) resource;
        assertFalse(medicationRequest.getDosageInstruction().isEmpty());
        Timing timing = medicationRequest.getDosageInstructionFirstRep().getTiming();
    ...
    public void testRouteCode() throws Exception {
        Resource resource = this.getMedicationRequest("Tests/MedicationINT/MedicationRouteCode.xml");
        assertNotNull(resource);
        MedicationRequest medicationRequest = (MedicationRequest) resource;
        assertFalse(medicationRequest.getDosageInstruction().isEmpty());
    ...
    public void testDoseQuantity() throws Exception {
        Resource resource = this.getMedicationRequest("Tests/MedicationINT/MedicationDoseSimpleQuantity.xml");
        assertNotNull(resource);
        MedicationRequest medicationRequest = (MedicationRequest) resource;
        assertFalse(medicationRequest.getDosageInstruction().isEmpty());
    ...
    public void testDoseRangeQuantity() throws Exception {
        Resource resource = this.getMedicationRequest("Tests/MedicationINT/MedicationDoseRangeQuantity.xml");
        assertNotNull(resource);
        MedicationRequest medicationRequest = (MedicationRequest) resource;
        assertFalse(medicationRequest.getDosageInstruction().isEmpty());
        Type dose = medicationRequest.getDosageInstructionFirstRep().getDoseAndRateFirstRep().getDose();
    ...
    public void testMedicationConsumable() throws Exception {
        Resource resource = this.getMedicationRequest("Tests/MedicationINT/MedicationConsumable.xml");
        assertNotNull(resource);
        MedicationRequest medicationRequest = (MedicationRequest) resource;
    ...
    public void testRepeatNumber() throws Exception {
        Resource resource = this.getMedicationRequest("Tests/MedicationINT/MedicationRepeatNumber.xml");
        assertNotNull(resource);
        MedicationRequest medicationRequest = (MedicationRequest) resource;
        assertFalse(medicationRequest.getDosageInstruction().isEmpty());
        Timing timing = medicationRequest.getDosageInstructionFirstRep().getTiming();
    ...
    public void testApproachSiteCode() throws Exception {
        Resource resource = this.getMedicationRequest("Tests/MedicationINT/MedicationApproachSiteCode.xml");
        assertNotNull(resource);
        MedicationRequest medicationRequest = (MedicationRequest) resource;
