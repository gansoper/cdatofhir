...
@Log4j2
public class CDABasicElementsConverter {
    ...
    private static CDABasicElementsConverter instance;
    private final CodeMappingProcessor codeMappingProcessor;

    private CDABasicElementsConverter(CodeMappingProcessor codeMappingProcessor) {
        this.codeMappingProcessor = codeMappingProcessor;
    }

    public static CDABasicElementsConverter getInstance(CodeMappingProcessor codeMappingProcessor) {
        if (instance == null) {
            instance = new CDABasicElementsConverter(codeMappingProcessor);
        }
        return instance;
    }
